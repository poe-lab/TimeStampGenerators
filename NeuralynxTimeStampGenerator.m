function varargout = NeuralynxTimeStampGenerator(varargin)
% NEURALYNXTIMESTAMPGENERATOR M-file for NeuralynxTimeStampGenerator.fig
% Created by Brooks A. Gross on 02.22.2010
% --This program is used to create 
%      NEURALYNXTIMESTAMPGENERATOR, by itself, creates a new NEURALYNXTIMESTAMPGENERATOR or raises the existing
%      singleton*.
%
%      H = NEURALYNXTIMESTAMPGENERATOR returns the handle to a new NEURALYNXTIMESTAMPGENERATOR or the handle to
%      the existing singleton*.
%
%      NEURALYNXTIMESTAMPGENERATOR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NEURALYNXTIMESTAMPGENERATOR.M with the given input arguments.
%
%      NEURALYNXTIMESTAMPGENERATOR('Property','Value',...) creates a new NEURALYNXTIMESTAMPGENERATOR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NeuralynxTimeStampGenerator_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NeuralynxTimeStampGenerator_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NeuralynxTimeStampGenerator
% VERSION 2.0
...
%   user intervention.
%
% Last Modified by GUIDE v2.5 19-Feb-2010 10:05:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NeuralynxTimeStampGenerator_OpeningFcn, ...
                   'gui_OutputFcn',  @NeuralynxTimeStampGenerator_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NeuralynxTimeStampGenerator is made visible.
function NeuralynxTimeStampGenerator_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NeuralynxTimeStampGenerator (see VARARGIN)

% Choose default command line output for NeuralynxTimeStampGenerator
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes NeuralynxTimeStampGenerator wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = NeuralynxTimeStampGenerator_OutputFcn(hObject, eventdata, handles) 
